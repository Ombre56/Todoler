...
class TasksVeryImportantWidget extends StatefulWidget {
  const TasksVeryImportantWidget({Key key}) : super(key: key);

  @override
  _TasksVeryImportantWidgetState createState() =>
      _TasksVeryImportantWidgetState();
}

class _TasksVeryImportantWidgetState extends State<TasksVeryImportantWidget>
                ...
                child: PagedListView<DocumentSnapshot<Object>, TasksRecord>(
                  ...
                  builderDelegate: PagedChildBuilderDelegate<TasksRecord>(
                    ...
                    itemBuilder: (context, _, listViewIndex) {
                      ...
                      return Visibility(
                        visible:
                            (listViewTasksRecord.validity) == 'very Important',
                        child: Align(
